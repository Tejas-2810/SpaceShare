            ...
            <div className='container'>
                <div className=" m-5 p-5  ">
                    <form className='input-group bar container' onSubmit={handleSubmit}>
                        ...
                        <input type="text" className='form-control form-controlh' placeholder="Search Spaces to Rent. . . . ." aria-label="Input group example" aria-describedby="basic-addon1" required />
                        <select className='form-select' aria-label="Select Category" style={{ backgroundColor: 'rgba(0, 0, 0, 0.336)', backdropFilter: 'blur(20px)', color: 'white', borderRadius: '1rem' }} >
                            <option value="1">Any Space</option>
                            <option value="2">Warehouse</option>
                            <option value="3">Backyard</option>
                            <option value="4">Meeting Room</option>
                        </select>
