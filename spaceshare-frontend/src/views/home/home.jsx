...
//   const iconClickHandler = (home, type, location) => {
//     navigate({
//       pathname: "/search",
//       search: createSearchParams({
//         type,
...
//                 className="icon"
//                 onClick={() =>
//                   iconClickHandler("hotel", "Hotel", "San Francisco")
//                 }
//               >
//                 <FaHotel size={40} color="white" />
//                 <span>Hotel</span>
...
//                 className="icon"
//                 onClick={() =>
//                   iconClickHandler("lakefront", "Lakefront", "Chicago")
//                 }
//               >
//                 <FaWater size={40} color="white" />
//                 <span>Lakefront</span>
...
//                 className="icon"
//                 onClick={() =>
//                   iconClickHandler("beautiful_pools", "Pool", "Toronto")
//                 }
//               >
//                 <FaSwimmingPool size={40} color="white" />
//                 <span>Beautiful Pools</span>
...
//                 className="icon"
//                 onClick={() =>
//                   iconClickHandler("countryside", "Countryside", "Halifax")
//                 }
//               >
//                 <FaTractor size={40} color="white" />
//                 <span>Countryside</span>
...
//                 className="icon"
//                 onClick={() =>
//                   iconClickHandler("tree_houses", "Tree House", "Halifax")
//                 }
//               >
//                 <GiTreehouse size={40} color="white" />
//                 <span>Tree Houses</span>
...
//                 className="icon"
//                 onClick={() =>
//                   iconClickHandler("halifax_specials", "Special", "Halifax")
//                 }
//               >
//                 <FaHome size={40} color="white" />
//                 <span>Halifax Specials</span>
...
//               <div
//                 className="icon"
//                 onClick={() => iconClickHandler("farms", "Farm", "Toronto")}
//               >
//                 <GiFarmTractor size={40} color="white" />
//                 <span>Farms</span>
//               </div>
...
const Home = () => {
  ...
  const iconClickHandler = (type, location, spacecapacity) => {
    navigate({
      pathname: "/search",
      search: createSearchParams({
        type,
          ...
          <div className="m-5 p-5 hs1">
            ...
            <div className="icon-container">
              <div
                className="icon"
                onClick={() =>
                  iconClickHandler("Cafe + Meeting Rooms", "8820 spring garden", 120)
                }
              >
                <FaHotel size={40} color="white" />
                <span>Hotel</span>
              ...
              <div
                className="icon"
                onClick={() =>
                  iconClickHandler("Party", "5590 clyde garden", 125)
                }
              >
                <FaWater size={40} color="white" />
                <span>Lakefront</span>
              ...
              <div
                className="icon"
                onClick={() =>
                  iconClickHandler("Meeting Rooms", "5467 Robie Street", 20)
                }
              >
                <FaPlane size={40} color="white" />
                <span>Amazing Destinations</span>
              ...
              <div
                className="icon"
                onClick={() =>
                  iconClickHandler("Special", "Halifax", 10)
                }
              >
                <FaHome size={40} color="white" />
                <span>Halifax Specials</span>
              ...
              <div
                className="icon"
                onClick={() => iconClickHandler("Party", "5590 clyde garden", 125)}
              >
                <GiFarmTractor size={40} color="white" />
                <span>Farms</span>
              </div>
              <div
                className="icon"
                onClick={() =>
                  iconClickHandler("Party Space", "8790 spring garden", 78)
                }
              >
                <GiBarn size={40} color="white" />
                <span>SpaceShare Special</span>
